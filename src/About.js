import './About.css';
import ResumePDF from './media/doc/NixonWu_Resume.pdf'
...
function About() {
  ...
  <VerticalTimeline className='Timeline-Container'>
    ...
    >
        ...
        <h3 className="vertical-timeline-element-title"><a href={ResumePDF} className='download-resume' download="NixonWu_Resume.pdf">Download my Resume <i class="fas fa-download"></i></a></h3>
